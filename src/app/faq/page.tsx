...
const FAQS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Place names, coordinates, and ratings are sourced from Google Places in real time and cached for freshness. Opening hours are computed locally. That said, venues change — we always recommend verifying reservations and hours directly before you travel. Our Terms of Service cover this in detail.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. Open any saved itinerary and hit Export PDF. The full itinerary — all days, timeline, activities, meals, and transit — prints cleanly with your browser's native print dialog. Maps, affiliate cards, and interactive elements are excluded from the print output.",
      },
      {
