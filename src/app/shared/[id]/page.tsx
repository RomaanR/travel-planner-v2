...
export async function generateMetadata({
  ...
  return {
    title: `${trip.destination} Itinerary | TravalBee`,
    description: `A curated luxury journey to ${trip.destination}, generated by TravalBee.`,
    openGraph: {
      title: `${trip.destination} Itinerary | TravalBee`,
      description: `A curated luxury journey to ${trip.destination}, generated by TravalBee.`,
      type: "website",
    ...
    <div className="h-screen flex flex-col bg-paper overflow-hidden">
      ...
      <div className="shrink-0 pt-20 border-b border-ink/5">
        ...
        <div className="bg-ink px-6 md:px-10 py-3 flex items-center justify-between gap-4">
          ...
          >
            Curated by TravalBee &mdash; Create Your Own &rarr;
          </Link>
        </div>
